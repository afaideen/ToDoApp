...
package com.birdpeek.backendtest;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.birdpeek.backendtest.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/ToDoFirebaseProject-4cdd87d8a363.json"))
                .setDatabaseUrl("https://todofirebaseproject-5bae8.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("r2d2@todofirebaseproject-5bae8.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("afaideen@hotmail.com", "Recipient"));
//                    msg.setRecipients(Message.RecipientType.BCC, InternetAddress.parse("afaideen@gmail.com, afaideen@hotmail.com"));
